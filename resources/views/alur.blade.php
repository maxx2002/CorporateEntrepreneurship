...
<h1 class="text-center my-5 mx-5">ALUR PENDAFTARAN</h1>
<div class="d-flex justify-content-center">
    <div class="widthpersen">
      <h2>Virtual Career Expo 2.0</h2>
      
        <p>Peserta berkunjung pada link 
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSf1UYSLbcKz3G7dX496TL8N2Qarg1PzM6gLvF1MhIQS9nkMng/viewform" target="_blank">bit.ly/UCCareerExpo2022</a> atau klik tombol daftar sekarang di bawah
            <br><br>
        ...
        <h2 class="mt-5">Webinar</h2>

        <p>Peserta berkunjung pada link 
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSfSvdlbTcVVRkG9hP_fLhlcMco-kQ8MXO4JlYuXTXFq9T7inQ/viewform" target="_blank">bit.ly/WebinarCE22</a> atau klik tombol daftar sekarang di bawah    
            <br><br>
            Peserta mengisi pertanyaan-pertanyaan yang sudah tertera di dalam G-form. Jika peserta ingin mengikuti seluruh kegiatan Virtual Career Expo 2.0 (2 hari berturut-turut) maka dapat mencentang (checklist) Day 1 & Day 2 kemudian peserta mengklik “submit”.
            <br><br>
            Peserta memilih link untuk dapat bergabung dalam grup WhatsApp sesuai dengan hari yang telah dipilih oleh peserta (bila mendaftar dua hari maka dapat bergabung ke grup Day 1 sekaligus grup Day 2).
